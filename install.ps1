<#
	.SYNOPSIS
		Installs the FunctionAppDeploymentTools Module from github
		
	.DESCRIPTION
		This script installs the FunctionAppDeploymentTools Module from github.
...
$ModuleName = "FunctionAppDeploymentTools"

# Base path to the github repository
$BaseUrl = "https://github.com/<InsertUsernameHere>/FunctionAppDeploymentTools"

# If the module is in a subfolder of the cloned repository, specify relative path here. Empty string to skip.
$SubFolder = "FunctionAppDeploymentTools"
