...
Remove-Module FunctionAppDeploymentTools -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\FunctionAppDeploymentTools.psd1"
Import-Module "$PSScriptRoot\..\FunctionAppDeploymentTools.psm1" -Force
