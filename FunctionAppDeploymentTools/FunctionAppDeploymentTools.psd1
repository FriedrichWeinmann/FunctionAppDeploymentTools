@{
	...
	RootModule = 'FunctionAppDeploymentTools.psm1'
	...
	# RequiredAssemblies = @('bin\FunctionAppDeploymentTools.dll')
	
	# Type files (.ps1xml) to be loaded when importing this module
	# TypesToProcess = @('xml\FunctionAppDeploymentTools.Types.ps1xml')
